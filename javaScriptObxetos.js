...
/* Recorre con un bucle o mapa gameEvents e mostra información de cada
...
for (const [minuto, evento] of gameEvents){
    const mitad = minuto < 45 ? "PRIMEIRA PARTE" : "SEGUNDA PARTE";
    console.log(`[${mitad}] ${minuto}: ${evento}`);
